...
# 全局变量
FILE_LIST="install-cobbler config-cobbler test-command one-key config-centos install-lnmp install-nodejs install-laravel config-laravel
           nodejs-package composer-package
           epel.repo
           ...
           .selinux.status .lnmp.status .my.cnf
          "
